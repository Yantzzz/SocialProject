...
- (UIViewController *)homeViewController
{
    ...
    homeController.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Home" image:[UIImage imageNamed:@"Home"] selectedImage:[UIImage imageNamed:@"Home-select"]];
...
- (UIViewController *)exploreViewController
{
    ...
    exploreController.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Explore" image:[UIImage imageNamed:@"Explore"] selectedImage:[UIImage imageNamed:@"Explore-select"]];
